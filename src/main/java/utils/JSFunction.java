...
public class JSFunction {
	...
	객체 생성 없이 클래스명으로 즉시 메소드를 호출할 수 있다.
	 */
    ...
    /*
    앞의 2개의 메소드는 JSP에서 out내장객체를 받은 후 Javascript함수를
    실행한다. 하지만 서블릿에서는 JSP의 내장객체를 매개변수로 받을 수 없으므로
    out내장객체 대신 response 내장 객체를 통해 컨텐츠 타입을 설정한 후
    JS코드를 실행해야 한다.
     */
